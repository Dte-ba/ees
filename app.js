...
var eesEngine = require('epm-ees-engine');
...
var epmApp = epmMiddleware({
  path: repodir, 
  engines: [{ name: 'epm-ees-engine', engine: eesEngine }],
  default: 'local'
});

var eesApp = ees({ public: path.join(__dirname, 'public'), epm: epmApp })
...
module.exports = function(ops){
  ...
  var port = ops.port || process.env.PORT || 8500;
